    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 pb-6">
      ...
      {isVisuallyImpaired && (
        <Button
          ...
          className="fixed top-4 right-4 z-40 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 shadow-lg"
        >
      ...
      <div className="max-w-md mx-auto px-4 -mt-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Button
            ...
            className={watchId !== null ? "" : "bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800"}
          >
            <MapPin className="w-4 h-4 mr-2" />
