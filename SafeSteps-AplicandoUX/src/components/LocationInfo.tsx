  ...
  return (
    <Card className="p-4 space-y-3">
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="flex items-start gap-2">
          <Navigation className="w-5 h-5 text-blue-500 mt-0.5 rotate-90" />
          <div>
        ...
        <div className="flex items-start gap-2">
          <Gauge className="w-5 h-5 text-purple-500 mt-0.5" />
          <div>
        ...
        <div className="flex items-start gap-2">
          <Navigation className="w-5 h-5 text-orange-500 mt-0.5 -rotate-45" />
          <div>
