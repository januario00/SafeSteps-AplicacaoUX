...
export function SecurityTerms({ onAccept, onDecline }: SecurityTermsProps) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'linear-gradient(to bottom right, #798DA7, #5D6F85, #465363)' }}>
      <Card className="w-full max-w-2xl p-8 space-y-6">
        ...
        <ScrollArea className="h-[400px] rounded-lg border p-6">
          <div className="space-y-4 text-sm text-gray-700">
            ...
            <div className="rounded-lg p-4 mt-6" style={{ background: '#E8EDF2', border: '1px solid #C5D0DC' }}>
              <div className="flex gap-3">
                <AlertTriangle className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: '#798DA7' }} />
                <div>
                  <p className="font-semibold mb-1" style={{ color: '#465363' }}>Importante</p>
                  <p className="text-sm" style={{ color: '#5D6F85' }}>
